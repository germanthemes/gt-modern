...
( function( wp, $ ) {
	...
	wp.customize( 'custom_logo', function( setting ) {
		setting.bind( function( value ) { 
			if ( '' !== value ) {
				...
				wp.customize.instance( 'gt_modern_theme_options[retina_logo]' ).set( false );
			}
		});
		...
		wp.customize.control( 'gt_modern_theme_options[retina_logo_title]', setupControl );
		wp.customize.control( 'gt_modern_theme_options[retina_logo]', setupControl );
	} );
	 ...
	 */
	wp.customize.controlConstructor.gt_modern_custom_font = wp.customize.Control.extend({
		/**
	 ...
	 * where type == the type member of a WP_Customize_Control
	 */
	wp.customize.controlConstructor.gt_modern_license_key = wp.customize.Control.extend({
		/**
		 * This method is called when the control is ready to run.
		 */
		ready: function() {
