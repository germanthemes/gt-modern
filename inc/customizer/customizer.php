...
function gt_modern_customize_preview_js() {
	wp_enqueue_script( 'gt-modern-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20200328', true );
...
function gt_modern_customizer_controls_js() {
	wp_enqueue_script( 'gt-modern-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20200825', true );
}
...
function gt_modern_customizer_controls_css() {
	wp_enqueue_style( 'gt-modern-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20200327' );
}
