 ...
 */
function gt_modern_customize_register_theme_color_settings( $wp_customize ) {

	// Add Section for Theme Colors.
	$wp_customize->add_section( 'gt_modern_section_theme_colors', array(
		'title'    => esc_html__( 'Theme Colors', 'gt-modern' ),
		'priority' => 40,
	...
	$wp_customize->add_setting( 'gt_modern_theme_options[title_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[title_color]', array(
			'label'    => esc_html_x( 'Titles', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[title_color]',
			'priority' => 40,
		)
	) );

	// Add Title Hover Color setting.
	$wp_customize->add_setting( 'gt_modern_theme_options[title_hover_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[title_hover_color]', array(
			'label'    => esc_html_x( 'Title Hover', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[title_hover_color]',
			'priority' => 50,
		)
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[link_color]', array(
			'label'    => esc_html_x( 'Links', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[link_color]',
			'priority' => 70,
		)
	) );

	// Add Link Hover Color setting.
	$wp_customize->add_setting( 'gt_modern_theme_options[link_hover_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[link_hover_color]', array(
			'label'    => esc_html_x( 'Link Hover', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[link_hover_color]',
			'priority' => 80,
		)
	) );

	// Add Button Color setting.
	$wp_customize->add_setting( 'gt_modern_theme_options[button_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[button_color]', array(
			'label'    => esc_html_x( 'Buttons', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[button_color]',
			'priority' => 90,
		)
	) );

	// Add Button Hover Color setting.
	$wp_customize->add_setting( 'gt_modern_theme_options[button_hover_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[button_hover_color]', array(
			'label'    => esc_html_x( 'Button Hover', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[button_hover_color]',
			'priority' => 100,
		)
	) );

	// Add Footer Color setting.
	$wp_customize->add_setting( 'gt_modern_theme_options[footer_color]', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control(
		$wp_customize, 'gt_modern_theme_options[footer_color]', array(
			'label'    => esc_html_x( 'Footer', 'Color Option', 'gt-modern' ),
			'section'  => 'gt_modern_section_theme_colors',
			'settings' => 'gt_modern_theme_options[footer_color]',
			'priority' => 110,
		)
	) );
}
add_action( 'customize_register', 'gt_modern_customize_register_theme_color_settings' );
