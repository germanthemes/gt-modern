...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Modern_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_modern_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-modern' ),
				'next'     => esc_html__( 'Next Font', 'gt-modern' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-modern' ),
			);

			// Set Fonts.
			$this->fonts = GT_Modern_Custom_Fonts::get_available_fonts();
