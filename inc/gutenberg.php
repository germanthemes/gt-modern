 ...
 * @return void
 */
function gt_modern_gutenberg_support() {
	...
	add_theme_support( 'editor-color-palette', apply_filters( 'gt_modern_editor_color_palette_args', array(
		array(
			'name'  => esc_html_x( 'Primary', 'block color', 'gt-modern' ),
			'slug'  => 'primary',
			'color' => esc_html( $theme_options['primary_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Secondary', 'block color', 'gt-modern' ),
			'slug'  => 'secondary',
			'color' => esc_html( $theme_options['secondary_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Accent', 'block color', 'gt-modern' ),
			'slug'  => 'accent',
			'color' => esc_html( $theme_options['accent_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Highlight', 'block color', 'gt-modern' ),
			'slug'  => 'highlight',
			'color' => esc_html( $theme_options['highlight_color'] ),
		),
		array(
			'name'  => esc_html_x( 'White', 'block color', 'gt-modern' ),
			'slug'  => 'white',
			'color' => '#ffffff',
		),
		array(
			'name'  => esc_html_x( 'Light Gray', 'block color', 'gt-modern' ),
			'slug'  => 'light-gray',
			'color' => esc_html( $theme_options['light_gray_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Gray', 'block color', 'gt-modern' ),
			'slug'  => 'gray',
			'color' => esc_html( $theme_options['gray_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Dark Gray', 'block color', 'gt-modern' ),
			'slug'  => 'dark-gray',
			'color' => esc_html( $theme_options['dark_gray_color'] ),
		),
		array(
			'name'  => esc_html_x( 'Black', 'block color', 'gt-modern' ),
			'slug'  => 'black',
			'color' => '#000000',
		),
	) ) );
	...
	add_theme_support( 'editor-font-sizes', apply_filters( 'gt_modern_editor_font_sizes_args', array(
		array(
			'name' => esc_html_x( 'Small', 'block font size', 'gt-modern' ),
			'size' => 16,
			'slug' => 'small',
		),
		array(
	...
	register_block_style( 'core/buttons', array(
		'name'         => 'gt-small',
		'label'        => esc_html__( 'GT Small', 'gt-modern' ),
	...
	register_block_style( 'core/buttons', array(
		'name'         => 'gt-large',
		'label'        => esc_html__( 'GT Large', 'gt-modern' ),
		'style_handle' => 'gt-modern-stylesheet',
	) );
	...
	if ( function_exists( 'register_block_pattern' ) && function_exists( 'register_block_pattern_category' ) ) {
		...
		// Register GT Modern block pattern category.
		register_block_pattern_category( 'gt-modern', array( 'label' => esc_html__( 'GT Modern', 'gt-modern' ) ) );

		// Register Block patterns.
		register_block_pattern( 'gt-modern/hero-left', array(
			'title'      => esc_html__( 'Hero Left', 'gt-modern' ),
			...
			'categories' => array( 'gt-modern' ),
		) );

		register_block_pattern( 'gt-modern/hero-right', array(
			'title'      => esc_html__( 'Hero Right', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/features', array(
			'title'      => esc_html__( 'Features', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/portfolio-grid', array(
			'title'      => esc_html__( 'Portfolio Grid', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/portfolio-list', array(
			'title'      => esc_html__( 'Portfolio List', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/portfolio-gallery', array(
			'title'      => esc_html__( 'Portfolio Gallery', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/services-list', array(
			'title'      => esc_html__( 'Services List', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/services-about', array(
			'title'      => esc_html__( 'Services / About', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/services-columns', array(
			'title'      => esc_html__( 'Services Columns', 'gt-modern' ),
		...
		register_block_pattern( 'gt-modern/projects', array(
			'title'      => esc_html__( 'Projects', 'gt-modern' ),
...
add_action( 'after_setup_theme', 'gt_modern_gutenberg_support' );


/**
 * Enqueue block styles and scripts for Gutenberg Editor.
 */
function gt_modern_block_editor_assets() {

	// Get Theme Version.
	$theme_version = wp_get_theme()->get( 'Version' );

	// Enqueue Editor Styling.
	wp_enqueue_style( 'gt-modern-editor-styles', get_theme_file_uri( '/assets/css/editor-styles.css' ), array(), $theme_version, 'all' );

	// Enqueue Theme Settings Editor plugin.
	wp_enqueue_script( 'gt-modern-editor-theme-settings', get_theme_file_uri( '/assets/js/editor-theme-settings.js' ), array( 'wp-blocks', 'wp-element', 'wp-edit-post' ), $theme_version );
}
add_action( 'enqueue_block_editor_assets', 'gt_modern_block_editor_assets' );


/**
 * Add body classes in Gutenberg Editor.
 */
function gt_modern_gutenberg_add_admin_body_class( $classes ) {
	global $post;
...
add_filter( 'admin_body_class', 'gt_modern_gutenberg_add_admin_body_class' );
