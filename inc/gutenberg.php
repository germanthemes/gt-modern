...
function gt_modern_gutenberg_support() {
	...
	register_block_pattern( 'gt-modern/hero-section', array(
		'title'      => esc_html__( 'Hero Section', 'gt-modern' ),
	...
	register_block_pattern( 'gt-modern/portfolio', array(
		'title'      => esc_html__( 'Portfolio', 'gt-modern' ),
	...
	register_block_pattern( 'gt-modern/services', array(
		'title'      => esc_html__( 'Services', 'gt-modern' ),
